> **Superseded by [ADR 0002](0002-gpui-instead-of-electron.md).** The move off
> Electron removed the process boundary this decision was about: there is no
> IPC contract left to keep type-safe. Kept for the record.
