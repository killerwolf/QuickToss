...
Video is the exception — you get the poster frame rather than playback, and `O` opens the file in QuickTime. Improving that is tracked in [#37](https://github.com/killerwolf/QuickToss/issues/37).
